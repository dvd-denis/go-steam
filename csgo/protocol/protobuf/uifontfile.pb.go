...
var file_uifontfile_format_proto_rawDesc = []byte{
	...
	0x64, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x42, 0x05, 0x48, 0x01, 0x80, 0x01, 0x00,
}
...
func file_uifontfile_format_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_uifontfile_format_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_uifontfile_format_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_uifontfile_format_proto_msgTypes[2].Exporter = func(v any, i int) any {
