...
var file_engine_gcmessages_proto_rawDesc = []byte{
...
var (
	...
	file_engine_gcmessages_proto_rawDescData = file_engine_gcmessages_proto_rawDesc
)

func file_engine_gcmessages_proto_rawDescGZIP() []byte {
	file_engine_gcmessages_proto_rawDescOnce.Do(func() {
		file_engine_gcmessages_proto_rawDescData = protoimpl.X.CompressGZIP(file_engine_gcmessages_proto_rawDescData)
	})
...
func file_engine_gcmessages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_engine_gcmessages_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*CEngineGotvSyncPacket); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_engine_gcmessages_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_engine_gcmessages_proto_rawDesc = nil
